...
- question want to zipped zip on every day except Saturday and Sunday from 7 am until 6 pm
- to run it, we need crontab which run at every 07:00 on Monday until Friday we can type it on crontab like this '0 7 * * 1-5 bash /home/julius/Documents/SISOP/Modul_1/3d.sh'
- and also for every 18:00 on Monday until Friday we can type it on crontab like this '0 18 * * 1-5 bash /home/julius/Documents/SISOP/Modul_1/3e.sh'
- use unzip command to unzip "Collection.zip" on every Saturday and Sunday from 7 am until 6 pm while it is unzipped then remove the zipped one to clear it

![Screenshot from 2021-04-04 21-38-48](https://user-images.githubusercontent.com/77782259/113515072-74167e00-959c-11eb-8892-dccae7c0eecf.png)
